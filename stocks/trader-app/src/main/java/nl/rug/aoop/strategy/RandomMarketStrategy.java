...
/**
 * A strategy which places random market orders.
 */
public class RandomMarketStrategy implements TradeStrategy {
     ...
     */
    public RandomMarketStrategy(TraderFacade traderFacade) {
