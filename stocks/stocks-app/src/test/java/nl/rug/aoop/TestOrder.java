...
public class TestOrder {
    ...
    void testOrderCreation() {
        ...
        Order order = new Order(Order.Action.BUY, "client1", "AAPL", 100, 150.0, timestamp);
    ...
    void testOrderComparison() {
        ...
        Order buyOrder = new Order(Order.Action.BUY, "client1", "AAPL", 100, 150.0, timestamp1);
        Order sellOrder = new Order(Order.Action.SELL, "client2", "AAPL", 100, 150.0, timestamp2);
    ...
    void testOrderToJsonAndFromJson() {
        LocalDateTime timestamp = LocalDateTime.now();
        Order originalOrder = new Order(Order.Action.BUY, "client1", "AAPL", 100, 150.0, timestamp);
